...
<svelte:head>
	...
	<meta
		name="description"
		content="NextJob verbindet Auftraggeber mit lokalen Dienstleistern und Handwerkern in Shkodër."
	/>
</svelte:head>

<section class="bg-gray-50">
	<div class="mx-auto flex max-w-6xl flex-col items-center px-4 py-20 text-center md:py-28">
		<p class="mb-4 font-medium text-gray-500">NextJob Plattform</p>

		<h1 class="max-w-3xl text-4xl font-bold tracking-tight text-gray-900 md:text-6xl">
			Finde Hilfe. Finde Arbeit.
		</h1>
